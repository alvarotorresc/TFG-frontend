...
export default function LoggedInRoutesComponent() {
  return (
      ...
      {(auth) => (
        <Switch>
          ...
          <Route
            ...
            render={() => (
              <CreatePhenomena id={auth.researcherId}></CreatePhenomena>
            )}
          />
          <Route
            exact
          ...
          <Route
            ...
            strict
            path="/researchers"
            component={ResearcherContainer}
          />
          <Route
            exact
            strict
            path="/phenomena"
            component={PhenomenaContainer}
          />
